...
* [Setup](https://backend.turing.edu/module1/projects/battleship/setup)
* [Project Requirements](https://backend.turing.edu/module1/projects/battleship/requirements)
* [Submission](https://backend.turing.edu/module1/projects/battleship/submission)
* [Evaluation Rubric](https://backend.turing.edu/module1/projects/battleship/rubric)
...
## Battleship - Iteration 1  - Ships and Cells
________________
...
## Battleship - Iteration 2 - The Board
________________
#### Test Driven Development
In this iteration, you are required to use TDD to create your classes. Use the interaction pattern to determine what a method should do and write one or more tests to verify that expected behavior. Then you can implement the method. You should always write code with the purpose of making a test pass.
...
## Battleship - Iteration 4 - Additional Features
________________
